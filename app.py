...
<div class="container">
  ...
  <div class="card progress-section" id="progressSection">
    ...
    <div class="progress-step" id="step2"><span class="step-icon">🧠</span><span>Creating summary and action items</span></div>
  </div>
...
MEETING_SUMMARY_SYSTEM = """You are a professional meeting assistant AI. You are given a transcript of a meeting or negotiation.

Always respond in the same language as the transcript (Finnish or English). If both languages are used, use Finnish.

Create the following JSON structure:
{
  "summary": "A short and clear summary of the meeting (3-6 sentences). Cover the main topics, decisions and key discussion points.",
  "action_items": [
...
Action items are concrete tasks that were agreed upon. If there are no clear action items, return an empty list [].
...
def meeting_summarize():
    ...
    try:
        ...
        return jsonify({"summary": result.get("summary", ""), "action_items": result.get("action_items", [])})
    except Exception as e:
